...
import { TimecalDto, TimecalEvalDto, TimecalNextTimeDto, TimecalPredictDto, TimecalResponseDto } from './dto/timecal.dto';
...
export class TimecalService {
    ...
    calAnpha(dto: TimecalDto | TimecalPredictDto): number {
    ...
    calNextTime(dto: TimecalNextTimeDto): { time1: number, time2: number, state_1: String, state_2: String } {
        let state_1_next;
        let state_2_next;
        let time1_next;
        let time2_next;
    ...
    calPredictTime(dto: TimecalPredictDto): number {
        let gTime
        dto.D1 = Math.max(dto.D1, 0.01)
        dto.D2 = Math.max(dto.D2, 0.01)
        if (dto.state_1 === "red") {
